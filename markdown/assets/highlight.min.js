/*!
  Highlight.js v11.0.0-alpha1 (git: 02fab27856)
...
},A=x("//","$"),C=x("/\\*","\\*/"),S=x("#","$");var k=Object.freeze({
...
},COMMENT:x,C_LINE_COMMENT_MODE:A,C_BLOCK_COMMENT_MODE:C,HASH_COMMENT_MODE:S,
...
},H=Error();function G(e){if(Array.isArray(e.begin)){
if(e.skip||e.excludeBegin||e.returnBegin)throw j("skip, excludeBegin, returnBegin not compatible with multi-class"),
H
;if("object"!=typeof e.scope||null==e.scope)throw j("scope/className must be object"),
H;((e,n)=>{let t=0;const a=e.scope,i={},s={}
;for(let e=1;e<=n.length;e++)s[e+t]=a[e],i[e+t]=!0,t+=_(n[e-1])
;e._emit=i,e.scope=s})(e,e.begin),e.begin=f(e.begin,{joinWith:""
}),e.isMultiClass=!0}}function Z(e,{plugins:n}){function t(n,t){
...
;[R,L,G,$].forEach((e=>e(a,r))),e.compilerExtensions.forEach((e=>e(a,r))),
a.__beforeBegin=null,[D,I,B].forEach((e=>e(a,r))),a.isCompiled=!0;let l=null
;return"object"==typeof a.keywords&&a.keywords.$pattern&&(a.keywords=Object.assign({},a.keywords),
l=a.keywords.$pattern,
delete a.keywords.$pattern),l=l||/\w+/,a.keywords&&(a.keywords=F(a.keywords,e.case_insensitive)),
...
variants:null},n)))),e.cachedVariants?e.cachedVariants:W(e)?s(e,{
...
return!!e&&(e.endsWithParent||W(e.starts))}const Q=i,X=s,V=Symbol("nomatch")
;var J=(e=>{const t=Object.create(null),i=Object.create(null),s=[];let r=!0
...
;for(;void 0!==n[t];){if(!e._emit[t]){t++;continue}
const a=w.classNameAliases[e.scope[t]]||e.scope[t],i=n[t]
;a?A.addKeyword(i,a):(C=i,g()),t++}
})(e,n),C=""):e.scope&&A.openNode(w.classNameAliases[e.scope]||e.scope),
...
const t=e[0],a=n.substr(e.index),i=p(M,e,a);if(!i)return V;const s=M
;s.skip?C+=t:(s.returnEnd||s.excludeEnd||(C+=t),u(),s.excludeEnd&&(C=t));do{
M.scope&&!M.isMultiClass&&A.closeNode(),M.skip||M.subLanguage||(S+=M.relevance),
...
;throw e.mode=M,e}if("end"===s.type){const e=E(s);if(e!==V)return e}
...
;const v=Z(w,{plugins:s});let O="",M=l||v;const x={},A=new d.__emitter(d);(()=>{
const e=[];for(let n=M;n!==w;n=n.parent)n.scope&&e.unshift(n.scope)
...
context:n.slice(k-100,k+100),mode:t.mode,resultSoFar:O},_emitter:A};if(r)return{
language:e,value:Q(n),illegal:!1,relevance:0,errorRaised:t,_emitter:A,_top:M}
...
relavance:s.relevance},s.secondBest&&(e.secondBest={
language:s.secondBest.language,relavance:s.secondBest.relevance})}let p=!1
;function f(){
...
q("10.7.0","Please use highlightElement now."),_(e)),configure:e=>{d=X(d,e)},
initHighlighting:()=>{
...
autoDetection:N,inherit:X,addPlugin:e=>{(e=>{
...
})({});const Y=e=>({IMPORTANT:{scope:"meta",begin:"!important"},HEXCOLOR:{
...
begin:`\\b0[xX]((${oe})\\.?|(${oe})?\\.(${oe}))[pP][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:"\\b(0|[1-9](_*[0-9])*)[lL]?\\b"},{begin:`\\b0[xX](${oe})[lL]?\\b`},{
begin:"\\b0(_*[0-7])*[lL]?\\b"},{begin:"\\b0[bB][01](_*[01])*[lL]?\\b"}],
relevance:0};function ce(e,n,t){return-1===t?"":e.replace(n,(a=>ce(e,n,t-1)))}
const de="[A-Za-z$_][0-9A-Za-z$_]*",ge=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],ue=["true","false","null","undefined","NaN","Infinity"],be=[].concat(["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],["arguments","this","super","console","window","document","localStorage","module","global"],["Intl","DataView","Number","Math","Date","String","RegExp","Object","Function","Boolean","Error","Symbol","Set","Map","WeakSet","WeakMap","Proxy","Reflect","JSON","Promise","Float64Array","Int16Array","Int32Array","Int8Array","Uint16Array","Uint32Array","Float32Array","Array","Uint8Array","Uint8ClampedArray","ArrayBuffer","BigInt64Array","BigUint64Array","BigInt"],["EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"])
;function me(e){const n=de,t={begin:/<[A-Za-z0-9\\._:-]+/,
end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(e,n)=>{
const t=e[0].length+e.index,a=e.input[t];"<"!==a?">"===a&&(((e,{after:n})=>{
const t="</"+e[0].slice(1);return-1!==e.input.indexOf(t,n)})(e,{after:t
})||n.ignoreMatch()):n.ignoreMatch()}},a={$pattern:de,keyword:ge,literal:ue,
built_in:be
...
const _e=e=>b(/\b/,e,/\w$/.test(e)?/\b/:/\B/),pe=["Protocol","Type"].map(_e),fe=["init","self"].map(_e),he=["Any","Self"],Ee=["associatedtype","async","await",/as\?/,/as!/,"as","break","case","catch","class","continue","convenience","default","defer","deinit","didSet","do","dynamic","else","enum","extension","fallthrough",/fileprivate\(set\)/,"fileprivate","final","for","func","get","guard","if","import","indirect","infix",/init\?/,/init!/,"inout",/internal\(set\)/,"internal","in","is","lazy","let","mutating","nonmutating",/open\(set\)/,"open","operator","optional","override","postfix","precedencegroup","prefix",/private\(set\)/,"private","protocol",/public\(set\)/,"public","repeat","required","rethrows","return","set","some","static","struct","subscript","super","switch","throws","throw",/try\?/,/try!/,"try","typealias",/unowned\(safe\)/,/unowned\(unsafe\)/,"unowned","var","weak","where","while","willSet"],Ne=["false","nil","true"],ye=["assignment","associativity","higherThan","left","lowerThan","none","right"],we=["#colorLiteral","#column","#dsohandle","#else","#elseif","#endif","#error","#file","#fileID","#fileLiteral","#filePath","#function","#if","#imageLiteral","#keyPath","#line","#selector","#sourceLocation","#warn_unqualified_access","#warning"],ve=["abs","all","any","assert","assertionFailure","debugPrint","dump","fatalError","getVaList","isKnownUniquelyReferenced","max","min","numericCast","pointwiseMax","pointwiseMin","precondition","preconditionFailure","print","readLine","repeatElement","sequence","stride","swap","swift_unboxFromSwiftValueWithType","transcode","type","unsafeBitCast","unsafeDowncast","withExtendedLifetime","withUnsafeMutablePointer","withUnsafePointer","withVaList","withoutActuallyEscaping","zip"],Oe=m(/[/=\-+!*%<>&|^~?]/,/[\u00A1-\u00A7]/,/[\u00A9\u00AB]/,/[\u00AC\u00AE]/,/[\u00B0\u00B1]/,/[\u00B6\u00BB\u00BF\u00D7\u00F7]/,/[\u2016-\u2017]/,/[\u2020-\u2027]/,/[\u2030-\u203E]/,/[\u2041-\u2053]/,/[\u2055-\u205E]/,/[\u2190-\u23FF]/,/[\u2500-\u2775]/,/[\u2794-\u2BFF]/,/[\u2E00-\u2E7F]/,/[\u3001-\u3003]/,/[\u3008-\u3020]/,/[\u3030]/),Me=m(Oe,/[\u0300-\u036F]/,/[\u1DC0-\u1DFF]/,/[\u20D0-\u20FF]/,/[\uFE00-\uFE0F]/,/[\uFE20-\uFE2F]/),xe=b(Oe,Me,"*"),Ae=m(/[a-zA-Z_]/,/[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/,/[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/,/[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/,/[\u1E00-\u1FFF]/,/[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,/[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/,/[\u2C00-\u2DFF\u2E80-\u2FFF]/,/[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,/[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/,/[\uFE47-\uFEFE\uFF00-\uFFFD]/),Ce=m(Ae,/\d/,/[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),Se=b(Ae,Ce,"*"),ke=b(/[A-Z]/,Ce,"*"),Te=["autoclosure",b(/convention\(/,m("swift","block","c"),/\)/),"discardableResult","dynamicCallable","dynamicMemberLookup","escaping","frozen","GKInspectable","IBAction","IBDesignable","IBInspectable","IBOutlet","IBSegueAction","inlinable","main","nonobjc","NSApplicationMain","NSCopying","NSManaged",b(/objc\(/,Se,/\)/),"objc","objcMembers","propertyWrapper","requires_stored_property_inits","resultBuilder","testable","UIApplicationMain","unknown","usableFromInline"],Re=["iOS","iOSApplicationExtension","macOS","macOSApplicationExtension","macCatalyst","macCatalystApplicationExtension","watchOS","watchOSApplicationExtension","tvOS","tvOSApplicationExtension","swift"]
;var De=Object.freeze({__proto__:null,grmr_bash:e=>{const n={},t={begin:/\$\{/,
...
const n=Y(e),t=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE];return{name:"CSS",
...
$pattern:/[a-z-]+/,keyword:"and or not only",attribute:ne.join(" ")},contains:[{
begin:/[a-z-]+(?=:)/,className:"attribute"},...t,n.CSS_NUMBER_MODE]}]},{
className:"selector-tag",begin:"\\b("+ee.join("|")+")\\b"}]}},grmr_diff:e=>({
...
const n="[\xc0-\u02b8a-zA-Z_$][\xc0-\u02b8a-zA-Z_$0-9]*",t=n+ce("(?:<"+n+"~~~(?:\\s*,\\s*"+n+"~~~)*>)?",/~~~/g,2),a={
...
contains:[i,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,le,e.C_BLOCK_COMMENT_MODE]
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},le,i]}},grmr_javascript:me,
...
},l=le,c=e.COMMENT("/\\*","\\*/",{contains:[e.C_BLOCK_COMMENT_MODE]}),d={
...
const n=Y(e),t=se,a="([\\w-]+|@\\{[\\w-]+\\})",i=[],s=[],r=e=>({
className:"string",begin:"~?"+e+".*?"+e}),o=(e,n,t)=>({className:e,begin:n,
relevance:t}),l={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:ne.join(" ")},c={begin:"\\(",end:"\\)",contains:s,keywords:l,
relevance:0}
...
className:"selector-pseudo",begin:"::("+ae.join("|")+")"},{begin:"\\(",
...
grmr_scss:e=>{const n=Y(e),t=ae,a=te,i="@[a-z-]+",s={className:"variable",
...
keyword:"and or not only",attribute:ne.join(" ")},contains:[{begin:i,
...
begin:b(/\./,g(m(...pe,...fe))),end:m(...pe,...fe),excludeBegin:!0},s={
match:b(/\./,m(...Ee)),relevance:0
},r=Ee.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Ee.filter((e=>"string"!=typeof e)).concat(he).map(_e),...fe)}]},l={
$pattern:m(/\b\w+/,/#\w+/),keyword:r.concat(we),literal:Ne},c=[i,s,o],d=[{
match:b(/\./,m(...ve)),relevance:0},{className:"built_in",
match:b(/\b/,m(...ve),/(?=\()/)}],u={match:/->/,relevance:0},_=[u,{
className:"operator",relevance:0,variants:[{match:xe},{match:`\\.(\\.|${Me})+`}]
...
match:b(/`/,Se,/`/)},M=[O,{className:"variable",match:/\$\d+/},{
className:"variable",match:`\\$${Ce}+`}],x=[{match:/(@|#)available/,
className:"keyword",starts:{contains:[{begin:/\(/,end:/\)/,keywords:Re,
contains:[..._,f,v]}]}},{className:"keyword",match:b(/@/,m(...Te))},{
className:"meta",match:b(/@/,Se)}],A={match:g(/\b[A-Z]/),relevance:0,contains:[{
className:"type",
match:b(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,Ce,"+")
},{className:"type",match:ke,relevance:0},{match:/[?!]+/,relevance:0},{
match:/\.\.\./,relevance:0},{match:b(/\s+&\s+/,g(ke)),relevance:0}]},C={
begin:/</,end:/>/,keywords:l,contains:[...a,...c,...x,u,A]};A.contains.push(C)
;const S={begin:/\(/,end:/\)/,relevance:0,keywords:l,contains:["self",{
match:b(Se,/\s*:/),keywords:"_|0",relevance:0
},...a,...c,...d,..._,f,v,...M,...x,A]},k={beginKeywords:"func",contains:[{
className:"title",match:m(O.match,Se,xe),endsParent:!0,relevance:0},n]},T={
begin:/</,end:/>/,contains:[...a,A]},R={begin:/\(/,end:/\)/,keywords:l,
contains:[{begin:m(g(b(Se,/\s*:/)),g(b(Se,/\s+/,Se,/\s*:/))),end:/:/,
relevance:0,contains:[{className:"keyword",match:/\b_\b/},{className:"params",
match:Se}]},...a,...c,..._,f,v,...x,A,S],endsParent:!0,illegal:/["']/},D={
...
className:"title",match:xe,endsParent:!0,relevance:0}]},B={
beginKeywords:"precedencegroup",end:e.MATCH_NOTHING_RE,contains:[{
className:"title",match:ke,relevance:0},{begin:/{/,end:/}/,relevance:0,
endsParent:!0,keywords:[...ye,...Ne],contains:[A]}]};for(const e of v.variants){
...
},...c,...d,..._,f,v,...M,...x,A,S]}},grmr_typescript:e=>{const n={$pattern:de,
keyword:ge.concat(["type","namespace","typedef","interface","public","private","protected","implements","declare","abstract","readonly"]),
literal:ue,
built_in:be.concat(["any","void","number","boolean","string","object","never","enum"])
...
aliases:["yml"],contains:l}}});const Ie=J;for(const e of Object.keys(De)){
const n=e.replace("grmr_","");Ie.registerLanguage(n,De[e])}return Ie}()
